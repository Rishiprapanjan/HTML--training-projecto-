        ...
        <section className="portal-body">
              ...
              <div className="dashboard-row row-3" style={{ marginTop: "24px" }}>
                ...
                <div className="dashboard-col glass-panel" style={{ flex: 1, padding: "24px", borderRadius: "12px", border: "1px solid var(--glass-border)", height: "fit-content" }}>
                  ...
                  <form onSubmit={handleSaveEmployee} style={{ display: "flex", flexDirection: "column", gap: "16px", marginTop: "16px" }}>
                    ...
                    <button type="submit" className="btn-signin" style={{ width: "100%" }}>Login</button>
                  </form>
                </div>
          ...
          {activeTab === "Settings" && (
            <div className="settings-container glass-panel" style={{ padding: "24px" }}>
              ...
              <form onSubmit={(e) => { e.preventDefault(); alert("Company settings saved successfully!"); }} style={{ display: "flex", flexDirection: "column", gap: "16px", marginTop: "20px", maxWidth: "600px" }}>
                <div className="form-group">
          ...
          {activeTab === "Profile" && (
            <div className="profile-container glass-panel" style={{ padding: "24px" }}>
              ...
              <form onSubmit={(e) => { e.preventDefault(); alert("Admin Profile saved successfully!"); }} style={{ display: "flex", flexDirection: "column", gap: "16px", marginTop: "20px", maxWidth: "600px" }}>
                <div className="form-group">
